...
if rails_master?
  ...
  gem 'actionmailer', '>= 8.1.2.1', rails_version
  gem 'actionpack', '>= 8.1.2.1', rails_version
  gem 'actionview', '>= 7.2.3.1', rails_version
  gem 'activemodel', '>= 7.2.3.1', rails_version
  gem 'activerecord', '>= 7.2.3.1', rails_version
  gem 'activesupport', '>= 7.2.3.1', rails_version
  gem 'railties', '>= 8.1.2.1', rails_version
